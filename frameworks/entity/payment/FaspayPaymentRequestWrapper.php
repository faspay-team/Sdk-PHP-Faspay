...
/**
 * Description of FaspayPaymentRequestWrapper
 *
 * @author hilmananwarsah
 */
require_once __DIR__.'/../FaspayPaymentRequest.php';
require_once __DIR__.'/../../configs.php';
require_once __DIR__.'/../../entity/FaspayPaymentChannel.php';
require_once __DIR__.'/../../entity/payment/FaspayPaymentRequestBillData.php';
require_once __DIR__.'/../../entity/payment/FaspayPaymentRequestShippingData.php';
require_once __DIR__.'/../../entity/payment/FaspayPaymentRequestUserData.php';
require_once __DIR__.'/../../entity/FaspayCancelPaymentRequest.php';
...
class FaspayPaymentRequestWrapper extends FaspayPaymentRequest implements JsonSerializable{
    ...
    function __construct(configs $config, FaspayPaymentRequestBillData $billing, FaspayPaymentChannel $mFaspayPaymentChannel, FaspayPaymentRequestUserData $userData, FaspayPaymentRequestShippingData $mShippingData) {
